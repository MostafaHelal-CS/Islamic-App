...
function getHadith () {
    fetch(hadaithApi)
        ...
        .then(data => {
            ...
            let hadithBookName=["سنن ابو داود", "مسند الإمام أبي حنيفة", "صحيح البخاري", "الأربعون حديثاً للشاه ولي الله الدهلوي", "سنن ابن ماجه", "موطأ الامام مالك", "صحيح مسلم", "سنن النسايْي", "الأربعون حديثاً للنووي", "الأربعون حديثاً قدسياً", "جامع الترمذي"];
            ...
            for(let i=0; i<Object.values(data).length; i++) {
                ...
                theHadaithName.classList.add(`hadith${i}`);
