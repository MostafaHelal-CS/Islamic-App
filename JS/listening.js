...
let theAccordion=document.querySelector(".accordion");
theAccordion.addEventListener('click', () => {
    theAccordion.classList.toggle("active");
    let panel=theAccordion.nextElementSibling;
